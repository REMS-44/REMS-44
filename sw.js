...
messaging.onBackgroundMessage(payload=>{const n=payload.notification||{};const d=payload.data||{};self.registration.showNotification(n.title||"Майстерня режисури",{body:n.body||d.body||"Є зміни у твоєму розкладі.",icon:"./icons/icon-192.png",badge:"./icons/icon-96.png",data:{url:d.url||"./my.html"}})});
