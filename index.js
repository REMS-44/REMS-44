...
students.forEach(student=>{
  ...
  card.innerHTML=`<div class="student-photo-wrapper"><img class="student-image" src="${student.photo}" alt="${student.name}" loading="lazy"></div><div class="student-card-info"><h3>${student.name}</h3><p>${student.role}</p></div>`;
